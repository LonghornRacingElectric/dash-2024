...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId LARGE = 1;         // verdana_180_4bpp
    static const touchgfx::FontId SMALL = 2;         // verdana_50_4bpp
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // verdana_40_4bpp
    static const touchgfx::FontId TYPOGRAPHY_01 = 4; // verdana_35_4bpp
