...
//          Unicode::snprintf(CAN_MINBuffer, TEXTAREA1_SIZE, "%d", CAN_MIN);
//		}
//
//        if(id == 0x711) {//Dash 2
...
void Main_2View::setLapTime(int min, int sec, int hundredths, int thousandths){

}
void Main_2View::setAccelVal(int accel){
    bar_accel.setValue(accel);
}
